...
public class User {
	...
	private boolean isArchived, hasPassword, isApplicationManager, isStudent, isEmployee, isFamilyMember,
			isSchoolScheduler, isSchoolLeader, isStudentAdministrator, isTeamLeader, isSectionLeader, isMentor, isDean;
